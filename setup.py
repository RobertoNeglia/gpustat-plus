...
def read_version():
    ...
    setuptools_scm.dump_version(
        root=__PATH__, version=version, write_to="gpustat/_version.py"
    )
    return version
...
class DeployCommand(Command):
    ...
    def run(self):
        ...
        os.system(
            "GPUSTAT_VERSION='{}' sh -c '{} setup.py sdist'".format(
...
setup(
    ...
    entry_points={
        "console_scripts": [
            ...
            "gpustat=gpustat:main",  # Keep original name for compatibility
        ],
    },
    cmdclass={
